...
# %% -- prepare data -------------------------------------------- #
# define rdm data filename
data_fname = wdir + "data/fig1_data/group_task-percept_rsa-rdm.csv"

# load rdm data
data_rdm = pandas.read_csv(data_fname,
                       delimiter=",",
                       header=None)
...
# plot rdm
im = custom_grandRDMplot(data_rdm,'OrRd',ax,'Calibri',labels,True,True)
