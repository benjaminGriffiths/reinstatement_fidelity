...
for subj = 1 : n_subj
    ...
    % load pattern data
    load([dir_root,'bids_data/derivatives/',subj_handle,'/rsa-percept-audio/',subj_handle,'_task-rf_rsa-maskedVolume.mat'])
...
for subj = 1 : n_subj
    ...
    % load pattern data
    load([dir_subj,'/rsa-percept-audio/',subj_handle,'_task-rf_rsa-maskedDemeanedVolume.mat'])
    
    % load SPM.mat
    load([dir_subj,'/rsa-percept-audio/SPM.mat'])
...
for subj = 1 : n_subj
    ...
    % load data
    load([dir_root,'bids_data/derivatives/',subj_handle,'/rsa-percept-audio/',subj_handle,'_task-percept_rsa-FormattedVolume.mat'])
    load([dir_root,'bids_data/derivatives/',subj_handle,'/rsa-percept-audio/',subj_handle,'_task-rf_rsa-mask.mat'])
...
% load SPM details
load([dir_root,'bids_data/derivatives/group/rsa-percept-audio/SPM.mat'])
