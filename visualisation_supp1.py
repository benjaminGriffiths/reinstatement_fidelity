...
data_fname = wdir + "data/sup1_data/contrastModality_atEncoding_betas.csv"
...
# ----- Retrieval Plot ----- # 
# define raincloud data filename
data_fname = wdir + "data/sup1_data/contrastModality_atRetrieval_betas.csv"
...
# ----- Memory Plot ----- # 
# define raincloud data filename
data_fname = wdir + "data/sup1_data/retrievalSuccess_visual_betas.csv"
